...
CREATE INDEX IF NOT EXISTS idx_retrieval_events_conversation_id ON retrieval_events(conversation_id);
CREATE INDEX IF NOT EXISTS idx_retrieval_events_created_at ON retrieval_events(created_at);
CREATE INDEX IF NOT EXISTS idx_retrieval_events_user_id ON retrieval_events(user_id);

CREATE INDEX IF NOT EXISTS idx_audit_events_conversation_id ON audit_events(conversation_id);
